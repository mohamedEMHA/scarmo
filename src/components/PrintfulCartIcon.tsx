...
const PrintfulCartIcon: React.FC = () => {
  ...
  return (
    <motion.button
      className="relative p-2 rounded-lg transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-accent text-white bg-transparent hover:bg-white hover:border-black border border-transparent"
